...
<li>
	<div class="cssContent">
		<ul id="opt">
		<li>
	 	 <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);">
	  	</li>
	   	<li><a href="#" onClick="document.getElementsByName('content')[0].value='工作完成了';return false;">◎ 工作完成了</a></li>
	   	<li><a href="#" onClick="document.getElementsByName('content')[0].value='我还活着';return false;">◎ 我还活着</a></li>
	   	<li><a href="#" onClick="document.getElementsByName('content')[0].value='瘦了';return false;">◎ 瘦了</a></li>
	  	<li><a href="#" onClick="document.getElementsByName('content')[0].value='好多好吃的';return false;">◎ 好多好吃的</a></li>
	  	</ul>
	</div>
</li>
<li>
	<div class="cssContent">
	  ...
	  <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);">
	   ...
	   <li><a href="#" onClick="document.getElementsByName('content')[1].value='关心同事';return false;">◎ 关心同事</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[1].value='问候家人了';return false;">◎ 问候家人了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[1].value='给老人让坐';return false;">◎ 给老人让坐</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[1].value='忘记了';return false;">◎ 忘记了</a></li>
	   </ul>
	</div>
</li>
<li>
	<div class="cssContent">
	  ...
	  <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);">
	   ...
	   <li><a href="#" onClick="document.getElementsByName('content')[2].value='写工作总结';return false;">◎ 写工作总结</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[2].value='出去旅游';return false;">◎ 出去旅游</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[2].value='继续努力工作';return false;">◎ 继续努力工作</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[2].value='休息一下';return false;">◎ 休息一下</a></li></ul>
	</div>
</li>
<li>
	<div class="cssContent">
	  ...
	  <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);">
	   ...
	   <li><a href="#" onClick="document.getElementsByName('content')[3].value='效率提高了';return false;">◎ 效率提高了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[3].value='看书了';return false;">◎ 看书了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[3].value='状态好了';return false;">◎ 状态好了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[3].value='不再空想了';return false;">◎ 不再空想了</a></li></ul>
	</div>
</li>
<li>
...
<li>
	<div class="cssContent">
	  ...
	  <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);;">
	   ...
	   <li><a href="#" onClick="document.getElementsByName('content')[5].value='心情不错';return false;">◎ 心情不错</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[5].value='不给力';return false;">◎ 不给力</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[5].value='幸福';return false;">◎ 幸福</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[5].value='神马都是浮云';return false;">◎ 神马都是浮云</a></li></ul>
	</div>
</li>
<li>
	<div class="cssContent">
	  ...
	  <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);">
	   ...
	   <li><a href="#" onClick="document.getElementsByName('content')[6].value='她/他写九宫格日记了';return false;">◎ 她/他写九宫格日记了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[6].value='白菜贵了';return false;">◎ 白菜贵了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[6].value='大家都在关注神马';return false;">◎ 大家都在关注神马</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[6].value='新闻联播';return false;">◎ 新闻联播</a></li></ul>
	</div>
</li>
<li>
	<div class="cssContent">
	  ...
	  <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);">
	   ...
	   <li><a href="#" onClick="document.getElementsByName('content')[7].value='瘦了';return false;">◎ 瘦了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[7].value='胖了';return false;">◎ 胖了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[7].value='健康饮食';return false;">◎ 健康饮食</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[7].value='一日三餐不能少';return false;">◎ 一日三餐不能少</a></li></ul>
	</div>
</li>
<li>
	<div class="cssContent">
	  ...
	  <input name="content" type="text" size="30" maxlength="15" value="请在此输入文字" onFocus="writeText(this);">
	   ...
	   <li><a href="#" onClick="document.getElementsByName('content')[8].value='睡得很好';return false;">◎ 睡得很好</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[8].value='拥有自己的房子';return false;">◎ 拥有自己的房子</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[8].value='忘记了';return false;">◎ 忘记了</a></li>
	   <li><a href="#" onClick="document.getElementsByName('content')[8].value='努力做好自己';return false;">◎ 努力做好自己</a></li></ul>
	</div>
</li>
</ul>
</div>
