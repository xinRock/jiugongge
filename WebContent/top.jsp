...
<div id="top"></div>
<div id="navigation">
	<div style="float:left;color:#006700; width:400px" >
	<c:if test="${!empty sessionScope.userName}">		
		<b> <marquee scrolldelay=140 scrollamount=6 direction="right" behavior=alternate> &nbsp;&nbsp; 欢迎 ${sessionScope.userName} 登录九宫格日记网！</marquee></b>
	</c:if>
	<c:if test="${empty sessionScope.userName}">		
		<b> <marquee scrolldelay=140 scrollamount=6 direction="right" behavior=alternate> &nbsp;&nbsp; 欢迎光临九宫格日记网！</marquee></b>
	</c:if>
	</div>
