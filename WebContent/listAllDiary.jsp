...
function rotate${id.count }(){
	...
	<div style="margin:10px 10px 0px 10px;background-color:#FFFFFF; border-bottom-color:#CBCBCB;border-bottom-style:dashed;border-bottom-width: 1px;">
		<div id="diaryImg${id.count }" style="border:1px #DDDDDD solid;width:400px;background-color:#EEEEEE;">
		
			<div id="control${id.count }" style="display:none;padding: 10px;float:left;width:200px;">
